    ...
    public function table(Table $table): Table
    {
        ...
        return $table
            ...
            ->columns([
                ...
                TextColumn::make('deleted_at')->label('PLAT 2')->formatStateUsing(fn (Menu $record) => $record->secondDish->name ? $menu->secondDish->name : 'Aucun')
                    ->searchable(),

                TextColumn::make('id.updated')->label('DÉSSERT')->formatStateUsing(fn (Menu $record) => $record->dessert->name)
                    ->searchable(),
