<x-app-layout>
    ...
    <div class="container mx-auto">
        <x-section-header title='Détails sur le compte utilisateur'>
            <x-slot name="actions">
                <a href="{{ route('users.index') }}"
                    class="btn btn-sm bg-green-400  border border-gray-300 focus:outline-none hover:bg-gray-100 rounded-lg text-white hover:text-secondary-500 text-sm px-5 py-2 text-center mr-2 mb-2 uppercase font-medium ">
        ...
        <livewire:profil.user-profil-view :loggedInUser="$loggedInUser" />
    </div>
</x-app-layout>
