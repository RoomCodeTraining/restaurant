    ...
    <div class="border border-gray-300 py-3 my-5 mx-auto rounded-md bg-grey-200">
        ...
        <div class="px-2 py-3 grid grid-cols-1  sm:grid-cols-1 md:grid-cols-1 lg:grid-cols-4 xl:grid-cols-4 gap-1">
            ...
            <div class="w-full lg:max-w-full lg:flex cursor-pointer">
                <div class="h-auto lg:h-auto lg:w-1/3 flex-none bg-cover rounded-t lg:rounded-t-none lg:rounded-l text-center overflow-hidden" style="background-image: url({{asset('images/entree1.png')}}") title="Woman holding a mug"></div>
                <div class="border border-gray-400 lg:border-l-0 lg:border-t lg:border-gray-400 bg-gray-500 rounded-b lg:rounded-b-none lg:rounded-r flex flex-col justify-between leading-normal">
                    <div class="mb-4">
                        <p class="text-sm text-gray-600 flex items-center">
                            <h4 class="font-medium flex items-center space-x-2">
                                <span class="px-4 py-1 text-secondary-900 font-bold text-xl">Entrée</span>
                            </h4>
                        </p>
                        ...
                        <p class="text-gray-700 text-base px-2">Description de l'entrée.</p>
                    </div>
                </div>
            </div>
            <!--Card 2-->
            <div class="w-full lg:max-w-full lg:flex cursor-pointer">
                <div class="h-auto lg:h-auto lg:w-1/3 flex-none bg-cover rounded-t lg:rounded-t-none lg:rounded-l text-center overflow-hidden" style="background-image: url({{asset('images/plat2.png')}}") title="Woman holding a mug"></div>
                <div class="border border-gray-400 lg:border-l-0 lg:border-t lg:border-gray-400 bg-gray-500 rounded-b lg:rounded-b-none lg:rounded-r flex flex-col justify-between leading-normal">
                    <div class="mb-8">
                        <p class="text-sm text-gray-600 flex items-center">
                            <h4 class="font-medium flex items-center space-x-2">
                        ...
                        <div class="text-gray-900 font-bold text-xl mb-2">
                            <ul class="list-none px-4 text-gray-900 font-semibold">
                                <ul class="list-none px-4 text-gray-50 font-semibold">
                                    <li>{{ $menu->mainDish->name }}</li>
                        ...
                        <p class="text-gray-700 text-base px-2">Description du plat 1</p>
                    </div>
                </div>
            </div>
            <div class="w-full lg:max-w-full lg:flex cursor-pointer">
                <div class="h-auto lg:h-auto lg:w-1/3 flex-none bg-cover rounded-t lg:rounded-t-none lg:rounded-l text-center overflow-hidden" style="background-image: url({{asset('images/plat1.png')}}") title="Woman holding a mug"></div>
                <div class="border border-gray-400 lg:border-l-0 lg:border-t lg:border-gray-400 bg-gray-500 rounded-b lg:rounded-b-none lg:rounded-r flex flex-col justify-between leading-normal">
                    <div class="mb-8">
                        <p class="text-sm text-gray-600 flex items-center">
                            <h4 class="font-medium flex items-center space-x-2">
                        ...
                        <p class="text-gray-700 text-base px-2">Description du plat 2.</p>
                    </div>
                </div>
            </div>
            <!--Card 3-->
            <div class="w-full lg:flex cursor-pointer">
                <div class="h-auto lg:h-auto lg:w-1/3 flex-none bg-cover rounded-t lg:rounded-t-none lg:rounded-l text-center overflow-hidden" style="background-image: url({{asset('images/dessert1.png')}}") title="Woman holding a mug"></div>
                <div class="border border-gray-400 lg:border-l-0 lg:border-t lg:border-gray-400 bg-gray-500 rounded-b lg:rounded-b-none lg:rounded-r flex flex-col justify-between leading-normal">
                    <div class="mb-8">
                        <p class="text-sm text-gray-600 flex items-center">
                            <h4 class="font-medium flex items-center space-x-2">
                        ...
                        <p class="text-gray-700 text-base px-2">Description du dessert.</p>
                    </div>
                </div>
            </div>
        </div>
