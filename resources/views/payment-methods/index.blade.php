<x-app-layout>
    <x-section-header title="Méthodes de paiements">
        @can('manage', App\Models\PaymentMethod::class)
            <x-slot name="actions">
                <a href="{{ route('paymentMethods.create') }}" class="btn btn-sm btn-secondary">
    ...
    <div class="bg-white px-6 py-4 rounded-md shadow-lg">
        <livewire:payment-methods.payment-method-table/>
    </div>
</x-app-layout>
