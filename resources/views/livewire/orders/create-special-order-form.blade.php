<div>
    @if (app()->environment('production'))
        <div class="flex items-center p-4 mb-4 text-sm text-blue-800 border border-blue-300 rounded-lg bg-blue-50 dark:bg-gray-800 dark:text-blue-400 dark:border-blue-800"
            ...
            <div>
                <span class="font-medium">Fonctionnalité en en cours d'implementation'</span> Cette partie de commande
                concernera uniquement les collaborateurs de la centrale qui ont droit à deux plats.
            </div>
        </div>
    @else
        <div class='py-8 px-4'>
