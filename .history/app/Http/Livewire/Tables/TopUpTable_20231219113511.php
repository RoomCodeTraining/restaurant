...
class TopUpTable extends Component implements HasForms, HasTable
{
    ...
    public function table(Table $table): Table
    {
        return $table->query(
            ...
            SelectFilter::make('accessCard.paymentMethod.id')
                //->formatStateUsing(fn (PaymentMethod $record) => $record->name),
                ->options(fn (): array => PaymentMethod::query()->pluck('name', 'id')->all())
        ]);
    }
