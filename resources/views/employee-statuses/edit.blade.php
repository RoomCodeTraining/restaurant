<x-app-layout>
    <x-section-header title="Modifier une catégorie professionnelle">
        <x-slot name="actions">
            <a href="{{ route('employeeStatuses.index') }}" class="btn btn-sm btn-secondary">
    ...
    <livewire:employee-statuses.edit-employee-status-form :employeeStatus="$employeeStatus" />
</x-app-layout>
