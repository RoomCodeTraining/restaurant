            ...
            ->filters([
                Filter::make('created_at')
                    ...
                    ->indicateUsing(function (array $data): array {
                        ...
                        if ($data['Du'] ?? null) {
                            $indicators[] = Indicator::make('Créer à partir de  ' . Carbon::parse($data['Du'])->format('d/m/Y'))
                                ->removeField('Du');
                        }

                        if ($data['Au'] ?? null) {
                            $indicators[] = Indicator::make('Jusqu\'au ' . Carbon::parse($data['Au'])->toFormattedDateString('D/m/Y') . ' ' . Carbon::parse($data['Au)
                                ->removeField('Au');
                        }
