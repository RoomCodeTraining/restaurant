        <nav id="page-sidebar"
            class="flex flex-col fixed top-0 left-0 bottom-0 w-full lg:w-72 h-full bg-gray-800 border-r border-gray-100 transform transition-transform duration-100 ease-out z-20"
            x-bind:class="{
            ...
            <div class="overflow-y-auto customScroll">
                <div class="p-4 w-full">
                    <nav class="space-y-1">
                        ...
                        <x-nav-link href="{{ route('organizations.index') }}" icon="chart" :active="request()->routeIs('organizations.*')">
                            Sociétés
                        </x-nav-link>
                        <x-nav-link href="{{ route('users.index') }}" icon="chart" :active="request()->routeIs('users.*')">
                            Utilisateurs
                        </x-nav-link>
                        <div class="px-3 pt-5 pb-2 text-xs font-medium uppercase tracking-wider text-gray-500">
                            Gestion du restaurant
                        </div>
                        <x-nav-link href="{{ route('dishes.index') }}" icon="chart" :active="request()->routeIs('dishes.*')">
                            Plat
                        </x-nav-link>
                        <x-nav-link href="{{ route('menus.index') }}" icon="chart" :active="request()->routeIs('menus.*')">
                            Menu
                        </x-nav-link>
                        <div class="px-3 pt-5 pb-2 text-xs font-medium uppercase tracking-wider text-gray-500">
                        ...
                        <x-nav-link href="{{ route('orders.index') }}" icon="chart" :active="request()->routeIs('orders.*')">
                            Commandes
                        </x-nav-link>
                    </nav>
                </div>
