<x-app-layout>
    <section>
        <x-section-header title="Modifier le menu B">
            <x-slot name="actions">
                <a href="{{ route('menus-specials.index') }}" class="btn btn-sm btn-secondary hidden md:flex">
        ...
        <livewire:menus.edit-special-form :menuSpecials='$menuSpecials'>
    </section>
</x-app-layout>
