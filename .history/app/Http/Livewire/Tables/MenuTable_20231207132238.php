    ...
    public function table(Table $table): Table
    {
        ...
        return $table
            ...
            ->columns([
                ...
                TextColumn::make('id.dishes')->label('PLAT 2')->formatStateUsing(fn (Menu $menu) => $menu->second_dish?->name)
                    ->searchable(),

                TextColumn::make('')->label('DÉSSERT')->formatStateUsing(fn (Menu $menu) => $menu->second_dish?->name)
                    ->searchable(),
