<x-guest-layout>
    <div class="w-full h-screen flex">
        <div class="bg-white flex justify-center flex-col w-5/12 shadow-lg">
                    ...
                    <div class="px-12 pb-4">
                        <div class="w-full mb-2">
                            <div class="flex items-center">
                                ...
                                <input type='email' id="email" placeholder="Entrez votre adresse mail" type="email" name="email" :value="old('email')" class="-mx-6 px-8  w-full bg-opacity-25 rounded py-2 text-gray-700 focus:outline-none bg-accent-100" required autofocus  />
                            </div>
                        </div>
        ...
        <img src="{{asset('images/loginimg.jpg')}}" alt="background" class="object-cover object-center h-screen w-7/12">
    </div>
</x-guest-layout>
