    ...
    public function table(Table $table): Table
    {
        return $table
            ...
            ->columns([
                ...
                TextColumn::make('created_at')->formatStateUsing(fn (User $record) => $record->accessCard ? $record->accessCard->breakfast_reload_count : "Pas de quota")
                    ->label('Réchargement petit dejeuner')
                    ->hidden(),

                TextColumn::make('updated_at')->formatStateUsing(fn (User $record) => $record->accessCard ? $record->accessCard->breakfast_reload_count : "Pas de quota")
