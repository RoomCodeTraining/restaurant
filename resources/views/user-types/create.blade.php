<x-app-layout>
    <x-section-header title="Créer un type d'utilisateur">
        <x-slot name="actions">
            <a href="{{ route('userTypes.index') }}" class="btn btn-sm btn-secondary">
    ...
    <livewire:user-types.create-user-type-form />
</x-app-layout>
